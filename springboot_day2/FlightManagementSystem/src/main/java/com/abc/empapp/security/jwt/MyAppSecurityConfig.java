...
import com.abc.empapp.service.user.AppUserServiceImpl;
...
public class MyAppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.
                ...
                .antMatchers("/admin/passengers").hasAuthority("admin")
                .antMatchers("/passenger/flights").hasAuthority("employee")
